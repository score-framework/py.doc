...
# -*- coding: utf-8 -*-
#
# strg.at documentation build configuration file, created by
...
latex_documents = [
  ('index', 'strgat.tex', 'strg.at Documentation',
...
man_pages = [
    ('index', 'strgat', 'strg.at Documentation',
...
texinfo_documents = [
  ('index', 'strgat', 'strg.at Documentation',
   'Necdet Can Atesman', 'strgat', 'One line description of project.',
   'Miscellaneous'),
]
